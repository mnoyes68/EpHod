...
class EpHodModel():
    ...
    def __init__(self, rlat_path=None, params_path=None):
        ...
        self.rlat_model = self.load_RLAT_model(rlat_path=rlat_path, params_path=params_path)
    ...
    def load_RLAT_model(self, rlat_path=None, params_path=None):
